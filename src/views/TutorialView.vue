    ...
    <div class="main-layout">
      ...
      <div class="form-container">
        ...
        <div class="fancy-card-wrapper">
          ...
          <div class="fancy-card">
            <ul>
              ...
              <li><strong>小奇點：</strong>打勾後，正在佩帶小奇點徽章且數量在設定值以上的觀眾的發言會出現。</li>
            </ul>
          </div>
        </div>
        ...
        <div class="fancy-card-wrapper">
          ...
          <div class="fancy-card">
            <ul>
              <li><strong>發言使用者名稱：</strong>是否開頭要顯示「觀眾聊天室顯示名稱：」再接著發言內容。</li>
              <li><strong>打字顯示速度：</strong>打字呈現的效果每隔多久出現下一個字。</li>
              <li><strong>單行/多行訊息顯示：</strong>決定訊息會多行顯示，還是每次顯示單行分多次顯示。</li>
              <li><strong>單行模式每行顯示間隔：</strong>當字數在一行無法顯示時，SeagaTyper會分行顯示，一次顯示一行，每行之間顯示停留幾秒。</li>
              <li><strong>每則訊息間隔：</strong>當訊息呈現完成後，如果已經有新的發言在等待顯示，會停留多久才顯示新的發言。</li>
              <li><strong>末尾訊息停留畫面時長：</strong>如果今天沒有新的發言在等待顯示，最後一則訊息會停留在畫面多久(設0秒的話會一直停留)。</li>
              <li><strong>待顯示佇列訊息數上限：</strong>今天如果聊天室有大量發言等待顯示，等待顯示的訊息的上限。超過上限時會先剔除排隊中最舊的訊息。</li>
            </ul>
            <div class="note-block">
              <p>單行顯示：一次只顯示一行，超過長度的內容會分次顯示，每次間隔依據每行顯示間隔決定</p>
              <p>多行顯示：訊息一次顯示完全部內容，不會分次顯示，若字數太多的話超出視窗的內容不會顯示</p>
              <p style="color: red">!!!請注意!!! 多行模式超出視窗的字就不會顯示，要使用多行模式請確保瀏覽器視窗寬高設定足夠顯示訊息內容</p>
            </div>
          </div>
        </div>
        ...
        <div class="fancy-card-wrapper">
          ...
          <div class="fancy-card">
            <ol>
              ...
              <li>OBS瀏覽器來源寬度不限(盡量不要超過畫面寬度)、單行模式高度建議至少大於文字大小，網址就直接貼上即可。</li>
              <li>瀏覽器來源高度:單行模式建議至少是文字大小的1.5倍以上、多行模式請確認足夠塞下大部分觀眾單次的訊息內容。</li>
            </ol>
            <div class="note-block">
              <p>按下「複製 OBS瀏覽器來源 網址」的時候同時會把此網址的設定記錄在瀏覽器中。</p>
              <p>若想要載入其他設定請在設定頁面把網址後面加上 ?config=... 的內容即可套用。</p>
            </div>
          </div>
        </div>
